...
def _migration_002_scan_history(conn: sqlite3.Connection) -> None:
    """Add the ``scans`` and ``scan_failures`` tables for persistent
    scan-history bookkeeping."""
    for stmt in _M002_STATEMENTS:
        conn.execute(stmt)
